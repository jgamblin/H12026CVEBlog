...
**Spotlight: OpenClaw.** A project that barely existed a year ago, OpenClaw (Peter Steinberger's viral local AI agent, the subject of [Lex Fridman Podcast #491](https://lexfridman.com/peter-steinberger/)) is already one of the most-reported products of the half with **537 CVEs**. The striking part is who is doing the reporting: **VulnCheck alone assigned 500** of them (93%), disclosed steadily across the half rather than in a single dump. That is what a research magnet looks like, an outside team systematically working a hot new target. To its credit the project also embraced the CVE lifecycle itself, issuing advisories through GitHub as reports came in. I track its CVEs at [OpenClawCVEs](https://github.com/jgamblin/OpenClawCVEs).
